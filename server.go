...
func (s *EventSumServer) Stop() {

}

func (s *EventSumServer) AddFilter(name string, filter func(data eventData) eventData) {
...
func (s *EventSumServer) graceful(hs *http.Server, timeout time.Duration) {
